...
// 	. "github.com/thesephist/ink/internal"
// )
...
// func parseNumber(c *ctx) (int, NodeID, errParse) {
// 	return parseAnd2_(
// 		parseInt,
...
// func parseStringIn(c *ctx, quote byte) (int, NodeID, errParse) {
...
// // ” | 'abc' | 'abc\'def\n\\\r\tghi'
// func parseString(c *ctx) (int, NodeID, errParse) {
// 	switch {
// 	case c.len() == 0:
...
// func parseBoolean(c *ctx) (int, NodeID, errParse) {
// 	return parseMap(parseOr(
// 		parseBytes("true"),
// 		parseBytes("false"),
// 	), func(s string) (NodeID, errParse) {
// 		switch s {
// 		case "true":
...
// func parseIdentifier(c *ctx) (int, NodeID, errParse) {
// 	i := c.offset
...
// func parseLhs(c *ctx) (int, NodeID, errParse) {
// 	parseBlock1 := parseMap(
// 		parseBlock,
// 		func(b NodeID) (NodeID, errParse) {
...
// 				parseBlock1,
// 			),
// 			func(_ Unit, k NodeID) (NodeID, errParse) {
// 				return k, errParse{}
// 			},
// 		)(c.to(i))
// 		if err.Err != nil {
...
// func parseAssignment(c *ctx) (int, NodeID, errParse) {
// 	return parseAnd3(
// 		parseLhs,
// 		parseDefine,
// 		parseExpression,
// 		func(lvalue NodeID, _ string, rvalue NodeID) (NodeID, errParse) {
// 			return c.ast.Append(NodeExprBinary{c.pos(), OpDefine, lvalue, rvalue}), errParse{}
// 		},
// 	)(c)
// }

// func parseList(c *ctx) (int, NodeID, errParse) {
// 	return parseAnd3(
// 		parseBracketLeft,
// 		parseMany(parseExpression),
// 		parseBracketRight,
// 		func(_ byte, exprs []NodeID, _ byte) (NodeID, errParse) {
// 			return c.ast.Append(NodeLiteralList{c.pos(), exprs}), errParse{}
// 		},
// 	)(c)
// }

// func parseBlock(c *ctx) (int, NodeID, errParse) {
// 	return parseAnd3(
// 		parseParenLeft,
// 		parseMany(parseExpression),
// 		parseParenRight,
// 		func(_ byte, exprs []NodeID, _ byte) (NodeID, errParse) {
// 			exprs = fun.Filter(func(n NodeID) bool {
...
// func parseLiteral(c *ctx) (int, NodeID, errParse) {
// 	return parseOr(
// 		parseNumber,
// 		parseString,
// 		parseBoolean,
...
// func parseDict(c *ctx) (int, NodeID, errParse) {
// 	return parseAnd3(
// 		parseBraceLeft,
// 		parseMany(parseOr(
...
// 				parseColon,
// 				parseExpression,
// 				func(k NodeID, _ byte, v NodeID) (NodeObjectEntry, errParse) {
...
// 				parseIdentifier,
// 				func(k NodeID) (NodeObjectEntry, errParse) {
...
// 		)),
// 		parseBraceRight,
// 		func(_ byte, kvs []NodeObjectEntry, _ byte) (NodeID, errParse) {
// 			return c.ast.Append(NodeLiteralObject{c.pos(), kvs}), errParse{}
// 		},
// 	)(c)
// }

// func parseUnary(c *ctx) (int, NodeID, errParse) {
// 	return parseAnd2(
// 		parseByte('~'),
// 		parseExpression,
// 		func(_ byte, n NodeID) (NodeID, errParse) {
// 			return c.ast.Append(NodeExprUnary{c.pos(), OpNegation, n}), errParse{}
// 		},
// 	)(c)
// }

// func parseExpression(c *ctx) (int, NodeID, errParse) {
...
// 				parseFunctionArrow,
// 				parseExpression,
// 				func(_ string, body NodeID) (NodeID, errParse) {
// 					var args []NodeID
...
// 				parseMany(parseExpression),
// 				parseParenRight,
// 				func(_ byte, args []NodeID, _ byte) (NodeID, errParse) {
...
// 				),
// 				parseExpression,
// 				func(op byte, rhs NodeID) (NodeID, errParse) {
// 					mp := map[byte]Kind{
// 						'.': OpAccessor,
// 						'%': OpModulus,
// 						'*': OpMultiply,
...
// 					parseArrow,
// 					parseExpression,
// 					func(target NodeID, _ string, expression NodeID) (NodeMatchClause, errParse) {
// 						return NodeMatchClause{target, expression}, errParse{}
// 					},
// 				)),
// 				parseBraceRight,
// 				func(_ string, _ byte, clauses []NodeMatchClause, _ byte) (NodeID, errParse) {
